...
const SignInPage = ({setPage, username, setUsername, password, setPassword, handleSignIn}) => {
    ...
    return (
        <div>
                ...
                <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    Not a member?
                    <button onClick={() => handleChangePage()} class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Sing up now!</button>
                    </p>
                </div>
        </div>
    )
